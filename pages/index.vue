...
export default Vue.extend({
  ...
  methods: {
    ToUpperCaseAll() {
      this.customText = this.customText.toUpperCase()
    },

    ToLowerCaseAll() {
      this.customText = this.customText.toLowerCase()
    },

    ToCapitalizeSentence() {
      this.customText =
        this.customText.charAt(0).toUpperCase() +
        this.customText.slice(1).toLowerCase()
    },
